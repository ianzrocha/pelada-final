...
export async function updateParticipant(id, p) {
  ...
  try {
    ...
    console.error("Erro ao atualizar participante no localStorage", e);
  }
}
...
export async function removeParticipant(id) {
  ...
  try {
    ...
    console.error("Erro ao deletar participante no localStorage", e);
  }
}
...
export async function getMatches() {
  ...
  try {
    ...
    console.error("Erro ao ler partidas do localStorage", e);
    return [];
  }
}
...
export async function updateMatch(id, m) {
  ...
  try {
    ...
    console.error("Erro ao atualizar partida no localStorage", e);
  }
}
...
export async function removeMatch(id) {
  ...
  try {
    ...
    console.error("Erro ao deletar partida no localStorage", e);
  }
}
