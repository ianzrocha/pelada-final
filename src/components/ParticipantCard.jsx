      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ marginTop: 12, display: 'flex', gap:8, justifyContent: 'flex-end' }}>
            <button className="btn btn-sm btn-ghost" onClick={() => p._onEdit && p._onEdit(p)}>Editar</button>
          </div>
        </div>
      </div>
    </div>
