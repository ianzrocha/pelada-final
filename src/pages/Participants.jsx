...
export default function Participants() {
  ...
  async function onEditorSaved(updated) {
    if (updated && updated.deleted) {
      setList((prev) => prev.filter((it) => it.id !== updated.id));
      return;
    }
    ...
    <div style={{ maxWidth: "1400px", margin: "0 auto" }}>
      ...
      >
        ...
        <div className="d-flex gap-2 align-items-center flex-wrap">
          ...
          >
            <i class="bi bi-person-add"></i> Adicionar Participante
          </button>
        </div>
      </div>
      ...
      {showForm && (
        <div style={{ marginBottom: "2rem", animation: "slideIn 0.3s ease" }}>
          <form
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(15, 15, 15, 0.6) 0%, rgba(26, 26, 26, 0.8) 100%)",
              border: "1px solid rgba(246, 200, 76, 0.12)",
              borderRadius: "12px",
              padding: "2rem",
              ...
              <div className="col-12">
                ...
                <div className="row g-4">
                  <div className="col-12 col-md-4">
                    ...
                    <StarRating
                      value={form.offense}
                      onChange={(v) => handleChange("offense", v)}
                    />
                  </div>
                  <div className="col-12 col-md-4">
                    <label className="form-label text-muted small">
                ...
                <div className="d-flex gap-4">
                  ...
                  <div className="form-check form-switch">
                    <input
                      ...
                      onChange={(e) =>
                        handleChange("paymentPaid", e.target.checked)
                      }
                      style={{
                        width: "2.5rem",
                        height: "1.25rem",
            ...
            {list
              .filter(
                ...
                <div key={p.id} className="col-12 col-md-6 col-lg-4">
                  <ParticipantCard p={{...p, _onEdit: openEditor}} />
                </div>
              ))}
          </div>
        </div>
      ...
      {editing && (
        <ParticipantEditor participant={editing} onClose={closeEditor} onSaved={onEditorSaved} />
      )}
