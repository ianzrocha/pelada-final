    ...
    <div style={{maxWidth: '1400px', margin: '0 auto'}}>
      ...
      <div className="row g-4 mb-4">
        <div className="col-12 col-md-6">
          ...
          >
            <div>
              <h6 className="text-muted mb-3" style={{fontSize: '0.9rem', fontWeight: '600'}}><i className="bi bi-person-circle" style={{color: 'white', fontSize: "30px", paddingRight: '5px'}}></i> Participantes</h6>
        ...
        <div className="col-12 col-md-6">
          ...
          >
            <div>
              <h6 className="text-muted mb-3" style={{fontSize: '0.9rem', fontWeight: '600'}}><i className="bi bi-controller" style={{color: 'white', fontSize: "30px", paddingRight: '5px'}}></i> Partidas</h6>
              <div className="d-flex align-items-baseline justify-content-between">
                <div>
      ...
      <div className="row g-4">
        <div className="col-12 col-lg-6">
          ...
          >
            <h6 className="text-muted mb-4" style={{fontSize: '0.9rem', fontWeight: '600'}}><i className="bi bi-calendar-date" style={{color: 'white', fontSize: "30px", paddingRight: '5px'}}></i> Próxima Partida</h6>
            {nextMatch ? (
              <div>
              ...
              <div className="text-muted text-center py-5">
                <p style={{fontSize: '3rem', marginBottom: '1rem'}}><i className="bi bi-calendar2-week"></i></p>
        ...
        <div className="col-12 col-lg-6">
          ...
          >
            <h6 className="text-muted mb-4" style={{fontSize: '0.9rem', fontWeight: '600'}}><i className="bi bi-caret-right" style={{color: 'white', fontSize: "30px"}}></i> Atalhos Rápidos</h6>
