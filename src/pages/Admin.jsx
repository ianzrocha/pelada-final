...
export default function Admin() {
  ...
  const data = {
    ...
    datasets: [
      { data: [paid, pending], backgroundColor: ["#f6c84c", "#6c6c6c"] },
    ],
  };
      ...
      >
        <div className="d-flex justify-content-between align-items-start">
          <div>
            ...
            >
              Gerencie pagamentos e informações
            </p>
          </div>
          <button
      ...
      <div className="row g-4 mb-4">
        <div className="col-12 col-lg-5">
          ...
          >
            ...
            >
              <i class="bi bi-layers"></i> Resumo de Pagamentos
            </h3>
            ...
            >
              <div>
                ...
                <span className="text-warning">{list.length}</span>
              </div>
              <div>
                Pago: <span style={{ color: "#f6c84c" }}>{paid}</span>
              </div>
              <div>
                Pendente: <span style={{ color: "#6c6c6c" }}>{pending}</span>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <tr key={p.id} style={{ borderBottom: "1px solid #222" }}>
                      ...
                      <td>
                        {p.paymentPaid ? (
                          ...
                          <span
                            className="badge"
                            style={{ background: "#6c6c6c", color: "#fff" }}
                          >
                            ⏳ Pendente
                          </span>
                        )}
